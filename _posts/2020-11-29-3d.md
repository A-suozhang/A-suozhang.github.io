...
* [ScanNet](http://kaldir.vc.in.tum.de/scannet_benchmark/)
	* 室内Seg数据集
	* process code [here](https://github.com/daveredrum/Pointnet2.ScanNet)
...
* this [code repo](https://github.com/HuguesTHOMAS/KPConv-PyTorch) provide some dataset sources
