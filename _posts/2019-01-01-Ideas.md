...
4. 重现一下Async-Tri Training这种填补数据集的方法
   ...
   2. ??存疑,且非常关键
5. 基本还是需要采用Teacher-Student的一个结构否则很多地方都无法施展开来
6. 最后的场景可以是剪枝,但是剪枝基本建立在能够Online的基础上

### 那么,开始实验吧!
* 第一天测试了
  * ![](https://github.com/A-suozhang/MyPicBed/raw/master/img/20191028163734.png)
  * 说明了finetune好之后的模型,拿AdaBN还是有一些效果的
    * (前提是Batch够大,不然可能会还不如之前)
    * 所以需要一定的积累
  * 需要改一下层的算法
